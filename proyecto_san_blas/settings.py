"""
Django settings for proyecto_san_blas project.
...
INSTALLED_APPS = [
    ...
    'san_blas_app.apps.SanBlasAppConfig' ######################################################
]
...
ROOT_URLCONF = 'proyecto_san_blas.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'san_blas_app.context_processors.breadcrumbs_processor' ##########################################
            ],
        },
    },
]

WSGI_APPLICATION = 'proyecto_san_blas.wsgi.application'
